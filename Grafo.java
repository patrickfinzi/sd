            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.vertices = new java.util.ArrayList<Vertice>(_list8.size);
                Vertice _elem9;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.arestas = new java.util.ArrayList<Aresta>(_list11.size);
                Aresta _elem12;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Grafo struct) throws org.apache.thrift.TException {
      ...
      if (struct.vertices != null) {
        oprot.writeFieldBegin(VERTICES_FIELD_DESC);
        {
          ...
          for (Vertice _iter14 : struct.vertices)
          {
            _iter14.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.arestas != null) {
        oprot.writeFieldBegin(ARESTAS_FIELD_DESC);
        {
          ...
          for (Aresta _iter15 : struct.arestas)
          {
            _iter15.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetVertices()) {
        {
          ...
          for (Vertice _iter16 : struct.vertices)
          {
            _iter16.write(oprot);
          }
        }
      ...
      if (struct.isSetArestas()) {
        {
          ...
          for (Aresta _iter17 : struct.arestas)
          {
            _iter17.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.vertices = new java.util.ArrayList<Vertice>(_list18.size);
          Vertice _elem19;
          for (int _i20 = 0; _i20 < _list18.size; ++_i20)
          {
            _elem19 = new Vertice();
            _elem19.read(iprot);
            struct.vertices.add(_elem19);
          }
        }
        struct.setVerticesIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.arestas = new java.util.ArrayList<Aresta>(_list21.size);
          Aresta _elem22;
          for (int _i23 = 0; _i23 < _list21.size; ++_i23)
          {
            _elem22 = new Aresta();
            _elem22.read(iprot);
            struct.arestas.add(_elem22);
          }
        }
        struct.setArestasIsSet(true);
      }
